...
*/
public class WishlistDao extends AbstractDao<Wishlist, String> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Wishlist entity, long rowId) {
        return entity.getProductId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(Wishlist entity) {
        if(entity != null) {
            return entity.getProductId();
        } else {
            return null;
